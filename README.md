...
## Installation
1. Download **[MixamoControlRig_v1.0.0.zip](https://github.com/lexikong/maya-mixamo-control-rig/releases/download/v1.0.0/MixamoControlRig_v1.0.0.zip)** from the [latest release](https://github.com/lexikong/maya-mixamo-control-rig/releases).
